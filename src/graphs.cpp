...
int main(){
    ...
    auto [node_radius, layout] = recorder.compute_graph_layout(adj, AlgorithmRecorder::GraphLayoutType::CIRCULAR);
    recorder.record_unweighted_graph(adj,layout, node_radius,true,false);
